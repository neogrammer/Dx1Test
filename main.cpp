...
uint8_t g_ClientWidth = 1280Ui8;
uint8_t g_ClientHeight = 720Ui8;
...

{
...

    {
...

        {
            ...
            g_ClientWidth = (uint8_t)::wcstol(argv[++i], nullptr, 10);
...

        {
            ...
            g_ClientHeight = (uint8_t)::wcstol(argv[++i], nullptr, 10);
...
void Render()
{
    ...
    // clear
    {
        ...
        FLOAT clearColor[] = { 0.f, 0.6f, 0.9f, 1.0f };
